    ...
    <NcAppNavigation>
      ...
      <template id="app-nextpod-navigation" #list>
        <NcAppNavigationItem icon="icon-user" title="Episodes">
          <NcCounterBubble slot="counter"> 99+ </NcCounterBubble>
        ...
        <NcAppNavigationItem title="This is bullet item">
          ...
          <template slot="actions">
            ...
            <NcActionLink
              ...
              href="https://nextcloud.com"
            />
            <NcActionCheckbox :disabled="false"> Checkbox </NcActionCheckbox>
        ...
        >
          <template>
            <NcAppNavigationItem title="NcAppNavigationItemChild1">
              <NcAppNavigationIconBullet slot="icon" color="0082c9" />
            </NcAppNavigationItem>
            <NcAppNavigationItem
              title="NcAppNavigationItemChild2"
              icon="icon-category-enabled"
            />
            <NcAppNavigationItem
              title="NcAppNavigationItemChild3"
              icon="icon-category-enabled"
            />
            <NcAppNavigationItem
              title="NcAppNavigationItemChild4"
              icon="icon-category-enabled"
            />
          </template>
        </NcAppNavigationItem>
      ...
      <template #footer>
        <NcAppNavigationSettings> Example settings </NcAppNavigationSettings>
      </template>
    </NcAppNavigation>
