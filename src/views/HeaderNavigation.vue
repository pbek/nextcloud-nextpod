...
:root {
  ...
  --nextpod-navigation-spacing: calc(
    (var(--nextpod-navigation-height) - 44px) / 2
  );
}
</style>
...
.nextpod-navigation {
  ...
  padding: 0 var(--nextpod-navigation-spacing);
  padding-left: calc(
    var(--nextpod-navigation-height) + var(--nextpod-navigation-spacing)
  );
